...
function(DeclareCAmkESVM init_component)
    cmake_parse_arguments(PARSE_ARGV 1 VM_COMP
        ""
        ""
...
function(DeclareCAmkESVMRootServer camkes_config)
    cmake_parse_arguments(PARSE_ARGV 1 CAMKES_ROOT_VM
        ""
        ""
        "CPP_INCLUDES;CPP_FLAGS"
    )
...
function(AddToFileServer filename_pref file_dest)
    ...
    cmake_parse_arguments(PARSE_ARGV 2 CAMKES_FILESERVER
        ""
        ""
        "DEPENDS"
    )
...
function(DecompressLinuxKernel decompress_target decompressed_kernel_image compressed_kernel_image)
    ...
    cmake_parse_arguments(PARSE_ARGV 3 DECOMPRESS_KERNEL
        ""
        ""
        "DEPENDS"
    )
    ...
    add_custom_target(${decompress_target} DEPENDS "${CMAKE_CURRENT_BINARY_DIR}/decomp/${kernel_basename}")
    # Set parameter to tell the caller location of decompressed kernel image
    set(${decompressed_kernel_image} ${CMAKE_CURRENT_BINARY_DIR}/decomp/${kernel_basename} PARENT_SCOPE)
